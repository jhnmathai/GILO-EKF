...
# Read data
ground_truth = pd.read_csv('gt_street_06.txt', header=None, delim_whitespace=True)
ekf_1 = pd.read_csv('gilo_street_06.txt', header=None, delim_whitespace=True)
ekf_2 = pd.read_csv('lio_street_06.txt', header=None, delim_whitespace=True)
